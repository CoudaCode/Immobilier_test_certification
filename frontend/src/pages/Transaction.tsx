...
export default function Transaction() {
  ...
  const renderCartItem = (item: any) => (
    <div key={item._id} className="flex items-center p-1 border-t border-b">
      <div className="w-1/6">
        <img
      ...
      <div className="flex items-center w-1/3">
        ...
        <span className="px-1 text-center border">{item.quantity}</span>
        <button
      ...
      <main className="flex flex-col px-4 mt-8 lg:flex-row">
        <div className="lg:w-2/3">
          <h2 className="mb-4 text-xl font-bold text-gray-50">
            Biens sélectionnés <BiHomeCircle className="inline-block" />
          </h2>
